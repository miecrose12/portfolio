...
const Hero = () => {
  return (
    <motion.div id='home' className='hero' variants={textVariants} initial='initial' whileInView='animate'>
        ...
        <motion.p variants={textVariants}>I am a front end developer from Edo state, Nigeria with internship level experience in user/interface design and implementation</motion.p>
        <motion.div className="hero-action" variants={textVariants}>
            ...
            <motion.div className="hero-resume" variants={textVariants} onClick={handleResumeClick}>My resume</motion.div>
        </motion.div>
    </motion.div>
  );
};
